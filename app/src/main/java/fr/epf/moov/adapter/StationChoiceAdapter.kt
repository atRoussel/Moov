...
class StationChoiceAdapter(val listStations: List<Station>, val clickListener: (Station) -> Unit) :
    RecyclerView.Adapter<StationChoiceAdapter.PopUpViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopUpViewHolder {
        ...
        val view: View = layoutInflater.inflate(R.layout.station_choice_view, parent, false)
